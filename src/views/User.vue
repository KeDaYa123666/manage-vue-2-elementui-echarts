...
export default {
    data() {
        return {
            ...
            //     addr: ''
            // },
            form: this.getInitiaForm(),//使用方法来初始化表单，便于重置
            rules: {
                name: [
            ...
            modalType: 0,//0表示的新增的弹窗，1表示的编辑的弹窗
            total: 0,//当前的总台数
            pageData: {
                page: 1,
                limit: 10
    ...
    methods: {
        ...
        //重置表单数据的方法
        resetForm(){
            this.form = this.getInitialForm(); // 使用初始表单数据重置
            this.$refs.form.resetFields(); // 可选，确保验证状态也被重置
        },
        //弹窗关闭的时候
        handleClose() {
            //this.$refs.form.resetFields()
